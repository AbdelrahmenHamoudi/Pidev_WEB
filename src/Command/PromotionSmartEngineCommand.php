...
class PromotionSmartEngineCommand extends Command
{
    public function __construct(
        ...
        private \App\Service\PusherService $pusherService
    ) {
        parent::__construct();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($promotions as $promo) {
            ...
            if ($ageInHours > 24 && $promo->getStatus() === Promotion::STATUS_ACTIVE) {
                ...
                if ($views < 10 && $reservations == 0) {
                    ...
                    if ($currentDiscount < 50) {
                        ...
                        $promo->setAutoDiscountReason('low_engagement');
                    ...
                    if ($currentDiscount > 5) {
                        ...
                        $promo->setDiscountPercentage($newDiscount);
                        $promo->setDiscountFixed(null);
                        $promo->setAutoDiscountReason('high_demand');
                        $promo->setLastEngineCheck($now);
            ...
            // 2. SMART SCHEDULER (Simulation for log)
