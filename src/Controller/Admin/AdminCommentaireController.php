...
class AdminCommentaireController extends AbstractController
{
    ...
    // SHOW
    // ================================================================
    #[Route('/{idCommentaire}', name: 'app_admin_commentaire_show', methods: ['GET'], requirements: ['idCommentaire' => '\d+'])]
    ...
    // DELETE
    // ================================================================
    #[Route('/{idCommentaire}/delete', name: 'app_admin_commentaire_delete', methods: ['POST'], requirements: ['idCommentaire' => '\d+'])]
    ...
    // TOGGLE STATUT
    // ================================================================
    #[Route('/{idCommentaire}/toggle-statut', name: 'app_admin_commentaire_toggle_statut', methods: ['POST'], requirements: ['idCommentaire' => '\d+'])]
    ...
    private function hydrateCommentaire(Commentaire $commentaire, Request $request, EntityManagerInterface $em): void
    {
        $publicationId = (int) $request->request->get('idPublication', 0);
        $userId        = (int) $request->request->get('id_utilisateur', 0);
